...
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/models/Car.php";
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/models/SportsCar.php";
require_once $_SERVER['DOCUMENT_ROOT'] . $app_root . "/models/FamilyCar.php";
